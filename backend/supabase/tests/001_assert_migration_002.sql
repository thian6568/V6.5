...
-- Migration 033 order retention disposition export foundation checks.
do $$
declare
  missing_count integer;
begin
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 033 expected tables: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 033 expected enums: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_order_fk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_disposition_fk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_evidence_fk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_requested_by_fk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_generated_by_fk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_verified_by_fk'),
      ('marketplace_order_retention_disposition_export_events', 'order_ret_disp_export_events_record_fk'),
      ('marketplace_order_retention_disposition_export_events', 'order_ret_disp_export_events_order_fk'),
      ('marketplace_order_retention_disposition_export_events', 'order_ret_disp_export_events_actor_profile_fk')
  ) as expected(table_name, constraint_name)
  left join information_schema.table_constraints tc
    on tc.table_schema = 'public'
   and tc.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 033 expected foreign keys: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_reference_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_uri_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_hash_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_note_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_blocker_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_blocked_reason_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_ready_status_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_requested_status_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_generated_status_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_verified_status_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_blocked_status_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_cancelled_status_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_terminal_exclusive_chk'),
      ('marketplace_order_retention_disposition_export_records', 'order_ret_disp_export_records_metadata_object_chk'),
      ('marketplace_order_retention_disposition_export_events', 'order_ret_disp_export_events_status_change_chk'),
      ('marketplace_order_retention_disposition_export_events', 'order_ret_disp_export_events_note_chk'),
      ('marketplace_order_retention_disposition_export_events', 'order_ret_disp_export_events_manual_note_chk'),
      ('marketplace_order_retention_disposition_export_events', 'order_ret_disp_export_events_metadata_object_chk')
  ) as expected(table_name, constraint_name)
  left join information_schema.table_constraints tc
    on tc.table_schema = 'public'
   and tc.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 033 expected check constraints: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('order_ret_disp_export_records_reference_key'),
      ('order_ret_disp_export_records_one_active_per_order_idx'),
      ('order_ret_disp_export_records_order_id_idx'),
      ('order_ret_disp_export_records_disposition_id_idx'),
      ('order_ret_disp_export_records_evidence_id_idx'),
      ('order_ret_disp_export_records_requested_by_idx'),
      ('order_ret_disp_export_records_generated_by_idx'),
      ('order_ret_disp_export_records_verified_by_idx'),
      ('order_ret_disp_export_records_status_idx'),
      ('order_ret_disp_export_records_format_idx'),
      ('order_ret_disp_export_records_ready_at_idx'),
      ('order_ret_disp_export_records_requested_at_idx'),
      ('order_ret_disp_export_records_generated_at_idx'),
      ('order_ret_disp_export_records_verified_at_idx'),
      ('order_ret_disp_export_records_created_at_idx'),
      ('order_ret_disp_export_events_record_id_idx'),
      ('order_ret_disp_export_events_order_id_idx'),
      ('order_ret_disp_export_events_actor_profile_id_idx'),
      ('order_ret_disp_export_events_actor_role_idx'),
      ('order_ret_disp_export_events_event_type_idx'),
      ('order_ret_disp_export_events_previous_status_idx'),
      ('order_ret_disp_export_events_new_status_idx'),
      ('order_ret_disp_export_events_created_at_idx')
  ) as expected(index_name)
  left join pg_indexes i
    on i.schemaname = 'public'
   and i.indexname = expected.index_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 033 expected indexes: %', missing_count;
  end if;
end
$$;
...
$$;
-- Migration 035 order retention disposition export delivery review foundation checks.
do $$
declare
  missing_count integer;
begin
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 035 expected tables: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 035 expected enums: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_order_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_delivery_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_export_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_evidence_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_requested_by_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_reviewed_by_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_approved_by_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_events', 'ord_ret_disp_exp_del_rev_events_record_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_events', 'ord_ret_disp_exp_del_rev_events_order_fk'),
      ('marketplace_order_ret_disp_export_delivery_review_events', 'ord_ret_disp_exp_del_rev_events_actor_profile_fk')
  ) as expected(table_name, constraint_name)
  left join information_schema.table_constraints tc
    on tc.table_schema = 'public'
   and tc.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 035 expected foreign keys: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_reference_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_summary_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_note_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_failure_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_failed_reason_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_result_status_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_ready_status_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_requested_status_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_started_status_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_reviewed_status_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_approved_status_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_failed_status_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_cancelled_status_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_terminal_exclusive_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_records', 'ord_ret_disp_exp_del_rev_records_metadata_object_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_events', 'ord_ret_disp_exp_del_rev_events_status_change_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_events', 'ord_ret_disp_exp_del_rev_events_note_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_events', 'ord_ret_disp_exp_del_rev_events_manual_note_chk'),
      ('marketplace_order_ret_disp_export_delivery_review_events', 'ord_ret_disp_exp_del_rev_events_metadata_object_chk')
  ) as expected(table_name, constraint_name)
  left join information_schema.table_constraints tc
    on tc.table_schema = 'public'
   and tc.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 035 expected check constraints: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('ord_ret_disp_exp_del_rev_records_reference_key'),
      ('ord_ret_disp_exp_del_rev_records_one_active_per_order_idx'),
      ('ord_ret_disp_exp_del_rev_records_order_id_idx'),
      ('ord_ret_disp_exp_del_rev_records_delivery_id_idx'),
      ('ord_ret_disp_exp_del_rev_records_export_id_idx'),
      ('ord_ret_disp_exp_del_rev_records_evidence_id_idx'),
      ('ord_ret_disp_exp_del_rev_records_requested_by_idx'),
      ('ord_ret_disp_exp_del_rev_records_reviewed_by_idx'),
      ('ord_ret_disp_exp_del_rev_records_approved_by_idx'),
      ('ord_ret_disp_exp_del_rev_records_status_idx'),
      ('ord_ret_disp_exp_del_rev_records_result_idx'),
      ('ord_ret_disp_exp_del_rev_records_ready_at_idx'),
      ('ord_ret_disp_exp_del_rev_records_requested_at_idx'),
      ('ord_ret_disp_exp_del_rev_records_started_at_idx'),
      ('ord_ret_disp_exp_del_rev_records_reviewed_at_idx'),
      ('ord_ret_disp_exp_del_rev_records_created_at_idx'),
      ('ord_ret_disp_exp_del_rev_events_record_id_idx'),
      ('ord_ret_disp_exp_del_rev_events_order_id_idx'),
      ('ord_ret_disp_exp_del_rev_events_actor_profile_id_idx'),
      ('ord_ret_disp_exp_del_rev_events_actor_role_idx'),
      ('ord_ret_disp_exp_del_rev_events_event_type_idx'),
      ('ord_ret_disp_exp_del_rev_events_previous_status_idx'),
      ('ord_ret_disp_exp_del_rev_events_new_status_idx'),
      ('ord_ret_disp_exp_del_rev_events_created_at_idx')
  ) as expected(index_name)
  left join pg_indexes i
    on i.schemaname = 'public'
   and i.indexname = expected.index_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 035 expected indexes: %', missing_count;
  end if;
end
$$;
-- Migration 036 order retention disposition export delivery review approval foundation checks.
do $$
declare
  missing_count integer;
begin
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 036 expected tables: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 036 expected enums: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_order_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_review_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_delivery_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_export_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_evidence_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_requested_by_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_approver_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_secondary_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_events', 'ord_ret_disp_exp_del_rev_app_events_record_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_events', 'ord_ret_disp_exp_del_rev_app_events_order_fk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_events', 'ord_ret_disp_exp_del_rev_app_events_actor_profile_fk')
  ) as expected(table_name, constraint_name)
  left join information_schema.table_constraints tc
    on tc.table_schema = 'public'
   and tc.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 036 expected foreign keys: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_reference_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_summary_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_note_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_rejection_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_rejected_reason_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_decision_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_ready_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_requested_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_started_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_approved_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_rejected_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_cancelled_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_terminal_exclusive_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_records', 'ord_ret_disp_exp_del_rev_app_records_metadata_object_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_events', 'ord_ret_disp_exp_del_rev_app_events_status_change_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_events', 'ord_ret_disp_exp_del_rev_app_events_note_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_events', 'ord_ret_disp_exp_del_rev_app_events_manual_note_chk'),
      ('marketplace_order_ret_disp_exp_del_review_approval_events', 'ord_ret_disp_exp_del_rev_app_events_metadata_object_chk')
  ) as expected(table_name, constraint_name)
  left join information_schema.table_constraints tc
    on tc.table_schema = 'public'
   and tc.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 036 expected check constraints: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('ord_ret_disp_exp_del_rev_app_records_reference_key'),
      ('ord_ret_disp_exp_del_rev_app_records_one_active_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_order_id_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_review_id_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_delivery_id_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_export_id_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_evidence_id_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_requested_by_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_approver_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_secondary_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_status_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_decision_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_ready_at_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_requested_at_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_started_at_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_approved_at_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_rejected_at_idx'),
      ('ord_ret_disp_exp_del_rev_app_records_created_at_idx'),
      ('ord_ret_disp_exp_del_rev_app_events_record_id_idx'),
      ('ord_ret_disp_exp_del_rev_app_events_order_id_idx'),
      ('ord_ret_disp_exp_del_rev_app_events_actor_profile_id_idx'),
      ('ord_ret_disp_exp_del_rev_app_events_actor_role_idx'),
      ('ord_ret_disp_exp_del_rev_app_events_event_type_idx'),
      ('ord_ret_disp_exp_del_rev_app_events_previous_status_idx'),
      ('ord_ret_disp_exp_del_rev_app_events_new_status_idx'),
      ('ord_ret_disp_exp_del_rev_app_events_created_at_idx')
  ) as expected(index_name)
  left join pg_indexes i
    on i.schemaname = 'public'
   and i.indexname = expected.index_name
...
begin
  ...
  from (
    values
      ('public', 'marketplace_order_ret_disp_exp_del_review_release_records'),
      ('public', 'marketplace_order_ret_disp_exp_del_review_release_events')
  ) as expected(schema_name, table_name)
  left join information_schema.tables t
    on t.table_schema = expected.schema_name
   and t.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 037 expected tables: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('public', 'marketplace_order_ret_disp_exp_del_review_release_status'),
      ('public', 'marketplace_order_ret_disp_exp_del_review_release_result'),
      ('public', 'marketplace_order_ret_disp_exp_del_review_release_event'),
      ('public', 'marketplace_order_ret_disp_exp_del_review_release_actor')
  ) as expected(schema_name, type_name)
  left join pg_type t on t.typname = expected.type_name
  left join pg_namespace n on n.oid = t.typnamespace and n.nspname = expected.schema_name
  where n.oid is null;
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 037 expected enums: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_order_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_approval_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_review_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_delivery_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_export_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_evidence_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_requested_by_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_released_by_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_confirmed_by_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_events', 'ord_ret_disp_exp_del_rev_rel_events_record_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_events', 'ord_ret_disp_exp_del_rev_rel_events_order_fk'),
      ('marketplace_order_ret_disp_exp_del_review_release_events', 'ord_ret_disp_exp_del_rev_rel_events_actor_profile_fk')
  ) as expected(table_name, constraint_name)
  left join information_schema.table_constraints tc
    on tc.table_schema = 'public'
   and tc.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 037 expected foreign keys: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_reference_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_summary_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_note_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_failure_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_failed_reason_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_result_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_ready_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_requested_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_started_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_released_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_confirmed_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_failed_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_cancelled_status_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_terminal_exclusive_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_records', 'ord_ret_disp_exp_del_rev_rel_records_metadata_object_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_events', 'ord_ret_disp_exp_del_rev_rel_events_status_change_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_events', 'ord_ret_disp_exp_del_rev_rel_events_note_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_events', 'ord_ret_disp_exp_del_rev_rel_events_manual_note_chk'),
      ('marketplace_order_ret_disp_exp_del_review_release_events', 'ord_ret_disp_exp_del_rev_rel_events_metadata_object_chk')
  ) as expected(table_name, constraint_name)
  left join information_schema.table_constraints tc
    on tc.table_schema = 'public'
   and tc.table_name = expected.table_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 037 expected check constraints: %', missing_count;
  end if;
end
$$;
...
begin
  ...
  from (
    values
      ('ord_ret_disp_exp_del_rev_rel_records_reference_key'),
      ('ord_ret_disp_exp_del_rev_rel_records_one_active_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_order_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_approval_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_review_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_delivery_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_export_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_evidence_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_requested_by_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_released_by_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_confirmed_by_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_status_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_result_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_ready_at_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_requested_at_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_started_at_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_released_at_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_confirmed_at_idx'),
      ('ord_ret_disp_exp_del_rev_rel_records_created_at_idx'),
      ('ord_ret_disp_exp_del_rev_rel_events_record_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_events_order_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_events_actor_profile_id_idx'),
      ('ord_ret_disp_exp_del_rev_rel_events_actor_role_idx'),
      ('ord_ret_disp_exp_del_rev_rel_events_event_type_idx'),
      ('ord_ret_disp_exp_del_rev_rel_events_previous_status_idx'),
      ('ord_ret_disp_exp_del_rev_rel_events_new_status_idx'),
      ('ord_ret_disp_exp_del_rev_rel_events_created_at_idx')
  ) as expected(index_name)
  left join pg_indexes i
    on i.schemaname = 'public'
   and i.indexname = expected.index_name
  ...
  if missing_count > 0 then
    raise exception 'Missing Migration 037 expected indexes: %', missing_count;
  end if;
end
$$;
end
